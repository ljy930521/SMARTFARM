module.exports = {
    navBar: function (isHome, weather, userName) {
        let homeLink = isHome ? `<a class="nav-link active text-light" href="#" >Home</a>` : `<a class="nav-link text-light" href="/home">Home</a>`;
        return `
            <nav class="navbar navbar-expand-lg navbar-info bg-info">
                <img src="/smartfarm.png" class="d-inline-block align-top" style="width:100px;" alt="">&nbsp;&nbsp;&nbsp;
                <ul class="nav nav-pills mr-auto">
                    <li class="nav-item ">
                        ${homeLink}
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="/user/logout">로그아웃</a>
                    </li>
